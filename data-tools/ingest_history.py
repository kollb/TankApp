#!/usr/bin/env python3
"""
TankApp – Analyse-Aufbereitung: aus bundesweiten Tages-CSVs kampagnenfähige Zeitreihen bauen.
...
Ankerpunkte (Home + Kampagnenstädte) — und zwar im Schema aus `docs/referenz/DATENWERKZEUGE.md`.
Dieses Skript
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Tankerkönig-Rohhistorie → analysefertige CSV je Kampagne (Schema docs/referenz/DATENWERKZEUGE.md).",
    ...
    lines = ["# QA – Übernahme Tankerkönig-Historie", "",
             ...
             f"(Gate in docs/referenz/DATENWERKZEUGE.md: ≥ 85 %)", "",
