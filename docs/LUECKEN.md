...
> Stand: 17.09.2026 · App-Version 0.50.1. Abgleich von
...
| Beobachtungspanels mischen Vor-/Nach-Gesetz-Daten; Modell-Kalibrierung ebenfalls im Mischbestand (12-Uhr-Regel, Schritt 3 — ausgelagert 18.09.2026) | Entscheidung | Der Befund-Report ([BEFUND-12-UHR-REGEL.md](BEFUND-12-UHR-REGEL.md)) weist den Regime-Wechsel empirisch nach: Live so regeltreu wie möglich (100 % der Erhöhungen am Mittagspunkt), die Panels zeigten dagegen die Welt vor dem 01.04.2026. Bewusst nicht in dieser Lieferung: Anzeige-Bodenkante und Nach-Gesetz-Kalibrierung — beide zahldrehend (C12-/B25-Übung: entscheiden, nicht gratishebeln), und der Null-Pfad-Fensterlauf (42 Tage) muss gegen gapfill-Nachzug quantifiziert werden. DoD: [TODO.md](../TODO.md) B30. |
