...
| [GUI-UX-BEFUND.md](GUI-UX-BEFUND.md) | 15.09.2026 (App 0.38.0) | Vermessung der gebauten GUI gegen UI-NEUENTWURF: Befunde U1–U8 (Typografie, Geräte-Raster, Routing, Erklär-Treppe, Designsystem, Lighthouse-Gate, Props-Drilling) | **Erledigt in 0.40.0** — Nachweise im [../../CHANGELOG.md](../../CHANGELOG.md) und in [../../TODO.md](../../TODO.md); einzig offen: C12 (zweispaltiger Desktop-Inhalt) |
