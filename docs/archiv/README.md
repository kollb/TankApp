...
[Regime-Plan](../planung/REGIME.md). Technische Anleitungen stehen im
[Doku-Index](../README.md).

## Inhaltsverzeichnis

- [Bestand und Nachfolger](#bestand-und-nachfolger)
- [Herkunftsverweise](#herkunftsverweise)
- [Archivregeln](#archivregeln)

## Bestand und Nachfolger
...
Code-Kommentare nennen teils historische Paragraphen wie „Konzept §5.5“.
...
- Neue Berichte mit Datum im Namen sowie Banner für Stand und Nachfolger.
- Aktuelle Regeln und offene Arbeit vor der Archivierung extrahieren.
- Messwerte nicht rückwirkend umschreiben; lokale Links dürfen repariert werden.
- Alte Entwürfe nicht in aktuelle Anleitungen kopieren. Löschkandidaten und
  Pflegekonvention stehen in [Dokumentationspflege](../entwicklung/DOKUMENTATION.md).
