...
> **Archiviert — alte RP2-Anleitung.** Kanonisch ist [../RP2.md](../betrieb/RP2.md)
...
- ✅ `polling.json` liegt unter `~/TankApp/docs/analysis/stations/polling.json`
  (wie für den Collector, [INSTALL.md](../betrieb/INSTALL.md) §2.2) — **ohne diese
...
[docs/betrieb/INSTALL.md](../betrieb/INSTALL.md), Abschnitt „Danach auf dem NAS“.
...
kopieren ([INSTALL.md](../betrieb/INSTALL.md) §2.2), dann
