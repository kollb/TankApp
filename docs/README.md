...
| [QUALITAET.md](QUALITAET.md) | 0.53.0 | Budgets, Lasttest und Lighthouse-Schwellen sind von 0.54.0–0.59.0 unberührt (0.59.0/B4 bringt keine neuen Assets; das Studio-Blatt ist fest positioniert und der Tagesstreifen initial geschlossen ⇒ kein CLS). Der dort beschriebene `@sparticuz/chromium`-Weg ist mit 0.59.0 erneut gelaufen (Alltag 38/38, Demo 46 grün / 14 skipped); durchgesehen ist das Dokument im Ganzen gegen 0.53.0 |
...
| [MICROCOPY.md](MICROCOPY.md) | 0.55.2 | 0.56.0 ändert keinen Nutzertext (B0 ist unsichtbar); 0.59.0 (B4) trägt nur die Zeile „Günstigste Station jetzt“ (ohne Empfehlung kein Satz mehr, `sentence = null`) — der Rest ist gegen 0.55.2 geprüft |
| [BEFUND-UX-MATH-2026-09-19.md](BEFUND-UX-MATH-2026-09-19.md) | 0.55.2 | Stichtagsprüfung gegen 0.55.2 — der Befund bleibt als Prüfstand stehen; der Umsetzungsstand je Batch steht als Vermerk am Batch (B0 → 0.56.0, B2 → 0.57.0, B3 → 0.58.0, B4 → 0.59.0) |
...
| [ANALYSE-B0-B1-B2-2026-09-19.md](ANALYSE-B0-B1-B2-2026-09-19.md) | 0.57.0 | Stichtags-Gegenprüfung von B0–B2 gegen den Befund; 0.58.0 (B3) ist darin nicht nachgezogen |
...
| [UI-NEUENTWURF.md](UI-NEUENTWURF.md) | — | Entwurf, bewusst unabhängig vom Bestand; nur §13 (Raster) wurde mit 0.59.0/B4 gegen die Umsetzung nachgezogen (Navigation 3+1 statt 6 Punkte) |
