...
| wissen, was die Oberfläche sagt und wo das Textregelwerk nicht greift (Text-/UI-Befund T1–T8, V1–V5) | [GUI-TEXT-BEFUND.md](GUI-TEXT-BEFUND.md) |
...
| [GUI-TEXT-BEFUND.md](GUI-TEXT-BEFUND.md) | Vermessung der Nutzertexte gegen [MICROCOPY.md](MICROCOPY.md) und der UI-Flächen, die kein Test prüft: Du-Form, Ausrufezeichen, Alt-Wörter, Zahlen/Einheiten, Pfade und Env-Variablen im Text, Rohcodes, Lade-/Frischeformeln, themenblinde Diagrammfarben, Tooltip-Wissen, Meldungsstapel — Befunde T1–T8 und V1–V5 mit DoD, noch ohne Abnahme |
